# Aiden AI Onboard Agent Campaign

This folder contains the complete marketing asset package for the **Aiden AI Onboard Agent**.
...
### 3. Share Short Links
Once deployed, use the `short-links.md` file (generated after deployment) to share assets with clients.
