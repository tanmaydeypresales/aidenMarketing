...
async def main():
    try:
        ...
        print("Error: playwright not installed. Run 'pip install playwright' and 'python -m playwright install chromium'")
        return
    ...
    async with async_playwright() as p:
        ...
        if CAROUSEL_HTML.exists():
            ...
            print(f"Skipping Carousel: {CAROUSEL_HTML} not found")

        # 2. One-pager — A4
        if ONE_PAGER_HTML.exists():
            ...
            print(f"Skipping One-pager: {ONE_PAGER_HTML} not found")
