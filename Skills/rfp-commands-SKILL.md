...
| 14 | `/rfp-humanize` | Rewritten `<client>_Response` | **.md + .docx** (overwrites) | Step 7 |

**Shortcut:** `/rfp-full` runs all 14 commands in sequence (humanize is the final pass on the narrative).
